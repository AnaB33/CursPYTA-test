"""
While (cat timp) = bucla (loop) iterativa in care un cod se executa CAT TIMP o anumita conditie este adevarata
...
Daca varsta chiar este corect (numar) oprim bucla repetitiva, altfel continuam:
"""
while True:
    age = input("Introdu varsta:\n")
    if age.isdigit():
        break
print(f"Varsta mea este {int(age)}")
