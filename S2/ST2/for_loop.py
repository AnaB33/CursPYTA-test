...
print(list(range(1, 6))) # va afisa de la 1 la 5
...
"""
print("_" * 80)
numbers = range (1, 10, 2) # va fi 1, 3, 5, 7,
...
print('_' * 80)
students = ["Vlad", "Ana"]
for student in students:   # in loc de student merge si cartof, doar ca la print ar trb sa scriu {cartof} in loc de student
    print(f"buna, sunt {student}")
...
for x in range(5): # nu ar merge la dictionare cu for in for
