...
1. variabilele au nume identice, pentru a le putea identifica
...
4. in general, numele de constanta in python folosesc doar litere mari si underscore
5. numele de variabile pot incepe cu litere sau _, dar nu cu cifre
6. numele de variabile sunt case-sensitive
IMPORTANT: folostiti nume sugestive mereu
"""


varsta_mea = 31 # nume valid, bun
VARSTA_MEA = 31 # nume valid, nu e bun in Python => este de fapt o constanta
...
"""
print(varsta_mea)
varsta_mea = 50 # am schimba valoarea variabilei varsta_mea
print(varsta_mea)

"""
Putem atribui mai multe valori intr-o singura linie:
a, b, c = 10, 20, 30 <= trebuie sa avem potrivire de numar intre numele de variabile
