...
alfa = '1234'  #aceasta este un STRING, chiar daca are o valoare de numar
...
care ne ajuta sa schimbam tipul variabilei respective
"""
alfa = int(alfa) #as putea folosi si float aici, daca as vrea sa obtin un numar
...
#var_x = int(var_x)  #va da o eroare
...
Toate tipurile de date se pot converti la string
"""
