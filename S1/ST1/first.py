...
# Diezul permite comentarii doar pe linia pe care se afla si el, adica comentarii single-line

"""
Comentariu multi-line (adica mai multe linii)
Asa pot scrie cat text vreau eu, pe cate linii vreau,
Si nu mai trebuie sa pun alte caractere speciale.
"""
